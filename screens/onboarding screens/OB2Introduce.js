  ...
  return (
    <View style={styles.body}>
      <View style={styles.container}>
        ...
        <Text style={TextStyles.h3}>Which one of these are you?
          Don’t worry, you can always change it later on.</Text>
        <View style={{ marginTop: verticalScale(56) }}>
          <View style={{ flexDirection: 'row', justifyContent: 'space-around', marginBottom: verticalScale(16) }}>{renderBox(roles[0])}{renderBox(roles[1])}</View>
          <View style={{ flexDirection: 'row', justifyContent: 'space-around' }}>{renderBox(roles[2])}{renderBox(roles[3])}</View>
        </View>
      </View>
