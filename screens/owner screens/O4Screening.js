    ...
    <View style={styles.body}>
      <View style={styles.card}>
        ...
        <View>
          ...
          <Text style={[TextStyles.h2, styles.infoText]}>{age} years old</Text>
        </View>
      </View>
      <View style={styles.card}>
        ...
        <View>
          ...
          <View style={styles.tagsContainer}>
            {livingCondition.map(cond => (
              <Tag key={cond} title={cond} type='black' />
            ))}
          </View>
        </View>
      </View>
      <View style={styles.card}>
        ...
        <View>
          ...
          <View style={styles.tagsContainer}>
            {status.map(stat => (
              <Tag key={stat} title={stat} type='black' />
            ))}
          </View>
        </View>
      </View>
